...
const DEFAULT_MEMBERS = [
  { id: 1, name: 'Arjun Mehta',  phone: '9810000001', plan: 'Standard', trainer: 'Rahul Shah',  status: 'Active',  joined: '2024-10-01' },
  { id: 2, name: 'Sneha Gupta',  phone: '9810000002', plan: 'Premium',  trainer: 'Priya Patel', status: 'Active',  joined: '2024-11-15' },
  { id: 3, name: 'Vikram Joshi', phone: '9810000003', plan: 'Basic',    trainer: 'Rahul Shah',  status: 'Expired', joined: '2024-08-20' },
  { id: 4, name: 'Ananya Singh', phone: '9810000004', plan: 'Premium',  trainer: 'Priya Patel', status: 'Active',  joined: '2024-09-05' },
  { id: 5, name: 'Rohan Desai',  phone: '9810000005', plan: 'Standard', trainer: 'Arjun Mehta', status: 'Active',  joined: '2025-01-10' },
];
